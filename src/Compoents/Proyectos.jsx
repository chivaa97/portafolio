                    ...
                    <div className="containerp-proyect">
                        <div className="proyect-card">
                            ...
                            <div className="item2">
                                ...
                                <a rel="noreferrer" target="_blank" href='https://react-climatee.netlify.app/' className='boton btn btn-light'>
                                    Ver Proyecto
                                </a>
                                </div>
                            </div>
                        ...
                        <div className="proyect-card">
                            ...
                            <div className="item2">
                               ...
                               <p>
                                ...
                                <a rel="noreferrer" target="_blank" href='https://marve-site.netlify.app/' className='boton btn  btn-light'>
                                    Ver Proyecto
                                </a>
                               </div>
                            </div>
                        ...
                        <div className="proyect-card">
                            ...
                            <div className="item2">
                                ...
                                <a rel="noreferrer" target="_blank" href='https://tasks-mannager.netlify.app/' className='boton btn btn-light'>
                                    Ver Proyecto
                                </a>
                                </div>
                            </div>
                        ...
                        <div className="proyect-card">
                            ...
                            <div className="item2">
                               ...
                               <p>
                                ...
                                <a rel="noreferrer" target="_blank" href='https://react-chiva97-movie.netlify.app/' className='boton btn btn-light'>
                                    Ver Proyecto
                                </a>
                               </div>
                            </div>
